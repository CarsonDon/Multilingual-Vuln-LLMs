...
original_csv_file = "/mnt/sdrive/likai/DeepEval/newtest.csv"

# new CSV file path
new_csv_file = "/mnt/sdrive/likai/DeepEval/newtest_result.csv"
...
for index, row in df.iterrows():
    ...
    for lang in ['en', 'zh-cn', 'hi', 'ko', 'th', 'bn', 'jw', 'si']:
